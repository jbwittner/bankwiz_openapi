...
// @ts-ignore
import { GroupBankAcccountIndexDTO } from '../model';
/**
...
export const BankAccountServiceApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async getAllBankAccount(options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<GroupBankAcccountIndexDTO>>> {
...
export const BankAccountServiceApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        getAllBankAccount(options?: any): AxiosPromise<Array<GroupBankAcccountIndexDTO>> {
...
export interface BankAccountServiceApiInterface {
     ...
     * @memberof BankAccountServiceApiInterface
     */
    getAllBankAccount(options?: AxiosRequestConfig): AxiosPromise<Array<GroupBankAcccountIndexDTO>>;
