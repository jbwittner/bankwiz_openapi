...
export const TransactionApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        getTransactionsByBankAccount: async (bankAccountId: number, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'bankAccountId' is not null or undefined
            assertParamExists('getTransactionsByBankAccount', 'bankAccountId', bankAccountId)
            const localVarPath = `/transaction/findByBankAccount`;
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            let baseOptions;
            if (configuration) {
         ...
         * @throws {RequiredError}
         */
        getTransactionsByGroup: async (groupId: number, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'groupId' is not null or undefined
            assertParamExists('getTransactionsByGroup', 'groupId', groupId)
            const localVarPath = `/transaction/findByGroup`;
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            let baseOptions;
            if (configuration) {
...
export const TransactionApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async getTransactionsByBankAccount(bankAccountId: number, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<TransactionDTO>>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.getTransactionsByBankAccount(bankAccountId, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
        /**
         * 
         ...
         * @throws {RequiredError}
         */
        async getTransactionsByGroup(groupId: number, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<TransactionDTO>>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.getTransactionsByGroup(groupId, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
        /**
         * 
...
export const TransactionApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        getTransactionsByBankAccount(bankAccountId: number, options?: any): AxiosPromise<Array<TransactionDTO>> {
            return localVarFp.getTransactionsByBankAccount(bankAccountId, options).then((request) => request(axios, basePath));
        },
        /**
         * 
         * @summary Get all transactions for a group
         ...
         * @throws {RequiredError}
         */
        getTransactionsByGroup(groupId: number, options?: any): AxiosPromise<Array<TransactionDTO>> {
            return localVarFp.getTransactionsByGroup(groupId, options).then((request) => request(axios, basePath));
        },
        /**
         * 
         * @summary Update the transaction information
...
export interface TransactionApiInterface {
     ...
     * @memberof TransactionApiInterface
     */
    getTransactionsByBankAccount(bankAccountId: number, options?: AxiosRequestConfig): AxiosPromise<Array<TransactionDTO>>;
     ...
     * @memberof TransactionApiInterface
     */
    getTransactionsByGroup(groupId: number, options?: AxiosRequestConfig): AxiosPromise<Array<TransactionDTO>>;
...
export class TransactionApi extends BaseAPI implements TransactionApiInterface {
     ...
     * @memberof TransactionApi
     */
    public getTransactionsByBankAccount(bankAccountId: number, options?: AxiosRequestConfig) {
        return TransactionApiFp(this.configuration).getTransactionsByBankAccount(bankAccountId, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof TransactionApi
     */
    public getTransactionsByGroup(groupId: number, options?: AxiosRequestConfig) {
        return TransactionApiFp(this.configuration).getTransactionsByGroup(groupId, options).then((request) => request(this.axios, this.basePath));
    }
