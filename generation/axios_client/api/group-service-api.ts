...
export const GroupServiceApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         */
        addUserGroup: async (id: string, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'id' is not null or undefined
            assertParamExists('addUserGroup', 'id', id)
            const localVarPath = `/group/user/{id}`
...
export const GroupServiceApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async addUserGroup(id: string, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<UserGroupRightDTO>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.addUserGroup(id, options);
...
export const GroupServiceApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        addUserGroup(id: string, options?: any): AxiosPromise<UserGroupRightDTO> {
            return localVarFp.addUserGroup(id, options).then((request) => request(axios, basePath));
        },
        /**
         * 
         * @summary Create a group
...
export interface GroupServiceApiInterface {
     ...
     */
    addUserGroup(id: string, options?: AxiosRequestConfig): AxiosPromise<UserGroupRightDTO>;
...
export class GroupServiceApi extends BaseAPI implements GroupServiceApiInterface {
     ...
     */
    public addUserGroup(id: string, options?: AxiosRequestConfig) {
        return GroupServiceApiFp(this.configuration).addUserGroup(id, options).then((request) => request(this.axios, this.basePath));
    }
