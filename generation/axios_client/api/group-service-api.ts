...
export const GroupServiceApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         */
        addUserGroup: async (id: string, addUserGroupRequest: AddUserGroupRequest, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'id' is not null or undefined
            assertParamExists('addUserGroup', 'id', id)
            ...
            const localVarPath = `/group/{id}/user`
...
export const GroupServiceApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async addUserGroup(id: string, addUserGroupRequest: AddUserGroupRequest, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<UserGroupRightDTO>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.addUserGroup(id, addUserGroupRequest, options);
         ...
         * @throws {RequiredError}
         */
        async getUserGroups(options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<UserGroupRightDTO>>> {
...
export const GroupServiceApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        addUserGroup(id: string, addUserGroupRequest: AddUserGroupRequest, options?: any): AxiosPromise<UserGroupRightDTO> {
            return localVarFp.addUserGroup(id, addUserGroupRequest, options).then((request) => request(axios, basePath));
        },
        /**
         * 
         * @summary Create a group
         ...
         * @throws {RequiredError}
         */
        getUserGroups(options?: any): AxiosPromise<Array<UserGroupRightDTO>> {
...
export interface GroupServiceApiInterface {
     ...
     */
    addUserGroup(id: string, addUserGroupRequest: AddUserGroupRequest, options?: AxiosRequestConfig): AxiosPromise<UserGroupRightDTO>;
     ...
     * @memberof GroupServiceApiInterface
     */
    getUserGroups(options?: AxiosRequestConfig): AxiosPromise<Array<UserGroupRightDTO>>;
...
export class GroupServiceApi extends BaseAPI implements GroupServiceApiInterface {
     ...
     */
    public addUserGroup(id: string, addUserGroupRequest: AddUserGroupRequest, options?: AxiosRequestConfig) {
        return GroupServiceApiFp(this.configuration).addUserGroup(id, addUserGroupRequest, options).then((request) => request(this.axios, this.basePath));
    }
