...
export interface GroupServiceApiInterface {
     ...
     * @memberof GroupServiceApiInterface
     */
    deleteGroup(id: string, options?: AxiosRequestConfig): AxiosPromise<void>;
...
export class GroupServiceApi extends BaseAPI implements GroupServiceApiInterface {
    ...
    public deleteGroup(id: string, options?: AxiosRequestConfig) {
        return GroupServiceApiFp(this.configuration).deleteGroup(id, options).then((request) => request(this.axios, this.basePath));
    }
