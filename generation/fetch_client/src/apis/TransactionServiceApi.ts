...
export interface TransactionServiceApiInterface {
     ...
     * @memberof TransactionServiceApiInterface
     */
    getAllTransactionOfBankAccountRaw(requestParameters: GetAllTransactionOfBankAccountRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Array<TransactionDTO>>>;

    /**
     * Get all transaction of bank account
     */
    getAllTransactionOfBankAccount(requestParameters: GetAllTransactionOfBankAccountRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<Array<TransactionDTO>>;
...
export class TransactionServiceApi extends runtime.BaseAPI implements TransactionServiceApiInterface {
     ...
     * Get all transaction of bank account
     */
    async getAllTransactionOfBankAccountRaw(requestParameters: GetAllTransactionOfBankAccountRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Array<TransactionDTO>>> {
     ...
     * Get all transaction of bank account
     */
    async getAllTransactionOfBankAccount(requestParameters: GetAllTransactionOfBankAccountRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<Array<TransactionDTO>> {
